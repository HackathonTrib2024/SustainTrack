...
private fun RelayBaseComposable(
    ...
    RelayBox(
        modifier
            ...
            .then(if (clipToParent) Modifier.clip(shape) else Modifier),
...
// [AnnotatedString].
//
// This composible was created for the convenience of the caller and is
// modeled after the approach taken by the Compose library.
@OptIn(ExperimentalTextApi::class)
@Composable
fun RelayText(
    modifier: Modifier = Modifier,
...
fun RelayVector(
    ...
    RelayBaseComposable(
        ...
        // This code replaces a call to androidx.compose.foundation.Image.
        // That code was copied with modifications to prevent clipping
        // to the composable's bounding box.
        val semantics = Modifier.semantics {
            this.contentDescription = "shape description"
...
fun Modifier.tappable(
    ...
    Modifier.combinedClickable(
        ...
        onClick = if (onTap == null) ({}) else onTap,
    )
}
